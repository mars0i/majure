...
;;;
;;; This version uses deftype with :unsynchronized-mutable.
...
(deftype InstanceState [yard
                        buddies
                        ^:unsynchronized-mutable numStudents
                        ^:unsynchronized-mutable forceToSchoolMultiplier
                        ^:unsynchronized-mutable randomMultiplier
                        ^:unsynchronized-mutable tempering]
