(defproject students "0.1.0-SNAPSHOT"
  ...
  :main students.Students ; default action with 'lein run'
  :source-paths ["src/clojure"]
  :jvm-opts ["-Xmx2g"]
  :aot [students.Students students.StudentsWithUI]  ; unused alternative to inner class in Students: students.TemperingSteppable 
